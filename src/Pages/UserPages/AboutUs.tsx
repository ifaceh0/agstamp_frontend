...
//             <div className="mt-4">
//               <a href="/#subscribe"
//   className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-blue-900 font-bold py-2 px-6 rounded-full hover:from-yellow-400 hover:to-yellow-500 transition-all shadow-lg inline-block"
// >
//   Subscribe Now
// </a>
//             </div>
...
const AboutUs: React.FC = () => {
  ...
  // ✅ NEW: Handle subscribe navigation
      ...
      <div className="max-w-4xl w-full bg-white/5 backdrop-blur-sm rounded-3xl shadow-2xl p-6 md:p-10 border border-white/20 z-10">
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="mt-4">
              {/* ✅ FIXED: Changed from <a> to <button> with proper click handler */}
              <button
                onClick={handleSubscribeClick}
                className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-blue-900 font-bold py-2 px-6 rounded-full hover:from-yellow-400 hover:to-yellow-500 transition-all shadow-lg inline-block cursor-pointer"
              >
                Subscribe Now
              </button>
            </div>
