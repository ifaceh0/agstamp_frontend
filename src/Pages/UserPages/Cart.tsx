...
//   useRemoveAllCartItemMutation,
//   useGetShippingRatesQuery,
//   useUserCartItemQuery, // ✅ CORRECT: Use your existing query hook
// } from "../../Redux/Api/userApi";
// import { 
//   addToCartAction, 
//   updateSelectedCountry,
...
//   // ✅ SOLUTION: Fetch cart data on component mount
//   const { data: cartData, isLoading: cartLoading, refetch: refetchCart } = useUserCartItemQuery();
...
//   // SOLUTION 2: Sync cart data from API to Redux when it loads
//   useEffect(() => {
//     if (cartData) {
...
//   // SOLUTION 3: Show loading state while cart is being fetched
//   if (cartLoading) {
...
const Cart: React.FC = () => {
  ...
  // ✅ SOLUTION: Fetch cart data on component mount
  const { data: cartData, isLoading: cartLoading } = useUserCartItemQuery();
